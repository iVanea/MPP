...
public class Main {
	...
	public static void ordering1(List<Integer> list) {
		System.out.println(list.stream().sorted((a,b)->Integer.compare(Math.abs(a), Math.abs(b)))
	...
	public static void ordering2(List<String> words) {
		System.out.println(words.stream()
				.sorted((wordA, wordB)->new StringBuilder(wordA).reverse().toString().compareTo(new StringBuilder(wordB).reverse().toString()))
				.collect(Collectors.toList()));
