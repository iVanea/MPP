...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(LibraryLambda.countEmployeesBySalaryAndLetter.apply(list, 100000, 'E'));
		...
		System.out.println(LibraryLambda.fullNameEmployessBySalaryAndLetter.apply(list, 85000, 'R'));
	}
